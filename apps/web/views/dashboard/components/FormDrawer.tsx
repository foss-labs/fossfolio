...
export const FormDrawer = ({ open, onClose, userId }: Props) => {
    const { data: fromData, isLoading, refetch } = useEventParticipantsFormSubmissions(userId);

    return (
        <Drawer open={open} onClose={onClose} direction="right" size={350} className="p-5">
