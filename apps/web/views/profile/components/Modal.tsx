                ...
                <form onSubmit={handleSubmit(handleFormData)}>
                    ...
                    <ModalBody rowGap="30px" display="flex" flexDir="column">
                        ...
                        <FormControl isInvalid={!!errors.slug}>
                            ...
                            <Input type="string" placeholder="my hackathon" {...register('slug')} />
                            <FormHelperText>fossfolio/event/{watch('slug')}</FormHelperText>
                            <FormErrorMessage>slug should not be empty</FormErrorMessage>
                        </FormControl>
                        <FormControl isInvalid={!!errors.eventEnding}>
                            <FormLabel fontSize="14px">Start Date</FormLabel>
                            <Input
                                type="date"
                                placeholder="my hackathon"
                                {...register('eventStarting')}
                            />
                        ...
                        <FormControl isInvalid={!!errors.eventEnding}>
                            ...
                            <Input
                                type="date"
                                placeholder="my hackathon"
                                {...register('eventEnding')}
                            />
                            <FormErrorMessage>date should not be empty</FormErrorMessage>
                        </FormControl>
                        <FormControl isInvalid={!!errors.registrationEnd}>
