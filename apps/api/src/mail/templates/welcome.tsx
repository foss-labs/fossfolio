...
import { UserRegisteredEvent } from '../mail.service';
import React from 'react';

const baseUrl = process.env.CLIENT_URL ? `${process.env.CLIENT_URL}` : 'fossfolio.com';
                ...
                <Body className="bg-white my-auto mx-auto font-sans">
                    <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
                        ...
                        <Text className="text-black text-[14px] leading-[24px]">
                            You have successfully registered for Fossfolio. We are glad to have you
                            on board. You can now explore the events and start exploring the
                            community.
                        </Text>
