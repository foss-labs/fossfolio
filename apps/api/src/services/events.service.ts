...
import type { CreateEventDto } from './dto/create-events.dto';
...
import type { Events, User } from '@prisma/client';
...
export class EventsService {
				...
				data: {
					events: {
						create: {
							...
							maxTicketCount: d.maxTicketCount,
						},
					},
				},
			});
	...
	async handleEventUpdated(event: Events) {
		...
		const embedName = await this.AiService.generateEmbedding(
