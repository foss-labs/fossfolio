/*
  ...
  - Made the column `eventId` on table `Sponsor` required. This step will fail if there are existing NULL values in that column.

*/
-- CreateEnum
CREATE TYPE "TeamStatus" AS ENUM ('PENDING', 'INREVIEW', 'INVITATION', 'ACCEPTED', 'REJECTED', 'NOTACCEPTED');
